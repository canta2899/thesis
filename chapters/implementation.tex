...
The interrupt service routine, which executes on each timer tick according to the configured sample rate, performs an \mintinline{cpp}{analogRead()} and writes a new reading to the currently opened file. It is configured as follows:
